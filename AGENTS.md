...
python -m voice_to_slide.main generate recording.mp3

# Access individual modules
python -c "from voice_to_slide.transcriber import AudioTranscriber; print(AudioTranscriber.__doc__)"
```
...
The project includes `skills/pptx-enhanced/` with enhanced PPTX generation capabilities:
- Support for cached Unsplash images
- Chart generation with matplotlib
- HTML to PPTX conversion workflow
- See SKILL_SETUP.md for uploading custom skills to Anthropic

To use custom skill:
1. Upload skill using Anthropic Skills API or SDK
